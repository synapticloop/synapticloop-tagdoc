...
public class AllowableValueAnnotator extends AnnotatorBase {
	public static final String NAME = "AllowableValue";
	...
	public String parse(String marker, String paragraph) throws ParseException {
		...
		parsedBuffer.append("<" + tagName + "><value>" + markerParser(marker) + "</value>");

		parsedBuffer.append("<sub-" + tagName + ">" + MarkdownParser.parse(XmlUtil.xmlEncode(paragraph.trim())) + " ");
		parsedBuffer.append("</sub-" + tagName + "></" + tagName + ">");
